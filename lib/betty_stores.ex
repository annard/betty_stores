defmodule BettyStores do
  ...
  """
  @callback store(PID, key :: String.t, value :: term, timeout) :: :ok | {:error, String.t}

  @doc"""
  Retrieve the value for a given key.
  """
  @callback retrieve(PID, key :: String.t) :: {:ok, term} | :notfound | {:error, String.t}

  @doc """
  Delete the given key from the store.
  """
  @callback delete(PID, key :: String.t) :: :ok | {:error, String.t}

  @doc """
  Update the value for a given key in the store. Returns the old value in case of success.
  """
  @callback update(PID, key :: String.t, new_value :: term, timeout) :: {:ok, old_value :: term} | {:error, String.t}
